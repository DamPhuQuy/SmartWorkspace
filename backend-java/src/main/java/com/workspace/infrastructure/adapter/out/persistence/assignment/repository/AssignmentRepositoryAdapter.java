...
import com.workspace.infrastructure.adapter.out.persistence.assignment.repository.AssigneeJpaRepository;
import com.workspace.infrastructure.adapter.out.persistence.assignment.repository.AssigneeMapper;
import com.workspace.infrastructure.adapter.out.persistence.assignment.repository.AssignmentJpaRepository;
import com.workspace.infrastructure.adapter.out.persistence.assignment.repository.AssignmentMapper;
import com.workspace.infrastructure.adapter.out.persistence.assignment.repository.SubmissionJpaRepository;
import com.workspace.infrastructure.adapter.out.persistence.assignment.repository.SubmissionMapper;
