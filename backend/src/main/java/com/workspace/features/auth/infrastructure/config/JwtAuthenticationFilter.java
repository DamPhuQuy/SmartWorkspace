...
import com.workspace.features.auth.application.service.JwtService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            // Handle errors quietly; Spring Security will block unauthorized access to protected endpoints
        }
        filterChain.doFilter(request, response);
    }
}
